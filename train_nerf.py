...
def train_nerf(
    ...
    for i in trange(start_iter, train_until, desc=str(device)):
        ...
        if USE_CACHED_DATASET:
            ...
            img_target = torch.tensor(images[img_idx]).to(device)
        ...
        if i % cfg.experiment.save_every == 0 or i == train_until - 1:
            checkpoint_dict = {
                "iter": i,
...
def main(device, cfg, load_checkpoint):
    # Load dataset
    (
        USE_CACHED_DATASET,
        train_paths,
...
if __name__ == "__main__":
    ...
    main(device, cfg, configargs.load_checkpoint)
